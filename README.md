...
In [Maximum_Likelihood_Estimation](./Maximum_Likelihood_Estimation/) folder I translate and guide step by step through the subject of Maximum Likelihood Estimation (MLE), showing how to calculate it for an exponential distribution. Additionally using sympy we calculate an expected value for mentioned distribution.